...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/unauthorized" element={<div style={{display:'flex',alignItems:'center',justifyContent:'center',height:'100vh',flexDirection:'column',gap:16}}><h2>403 – Access Denied</h2></div>} />
    ...
    <AuthProvider>
      <BrowserRouter>
        ...
        <Toaster position="top-right" toastOptions={{
          style: { background:'#ffffff', color:'#1e1b4b', border:'1px solid #e4e0ff', fontFamily:'Plus Jakarta Sans, sans-serif', fontSize:'0.875rem' },
